...
def detect_keypoints(scoremaps):
    ...
    keypoint_nine_coords = np.zeros((1, 2))
    v, u = np.unravel_index(np.argmax(scoremaps[:, :, 9]), (s[0], s[1]))
    keypoint_nine_coords[0, 0] = v
    keypoint_nine_coords[0, 1] = u
    print("nine",keypoint_nine_coords)
    # return keypoint_coords
    # return de 
    return keypoint_coords,keypoint_nine_coords
