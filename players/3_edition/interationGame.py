...
def gameState(pb_file,threshold):
    ...
    while game.is_end == False:
        keypoints_v,frame = game.keypoints, game.frame
        ...
        if keypoints_v.size == 42:
            ...
            if count == 0:
                ...
                if game.game_state == 1 and is_right_hand == 0 and score_label != 'Undefined':
                    ...
                    game.game_state = 2
                    # game.constraint_setting(game.left_panda)
...
if __name__ == "__main__":
    ...
    t1 = threading.Thread(target=gameState, args=(args.pb_file,args.threshold,))
